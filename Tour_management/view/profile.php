...
<style>
	body
	{
	background-image: url("css/t6.jpg");
}
	#cover-img{
		height: 400px;
		width: 100%;
	...
	<div class="col-sm-8">
		<?php
            ...
            <br><br>
				...
				<form action='profile.php?u_id='$user_id' method='post' enctype='multipart/form-data'><br><br><br><br><br><br>

				<label id='update_profile'> Select Profile <br><br>
...
<div class="row">
	...
	<div class="col-sm-2" style="background-color:white;text-align: center;left: 10%;border-radius: 5px;">
		<?php
		echo"
